...
class Template extends Generic implements TabInterface
{
    ...
    {
        /** @var \Mageplaza\ProductFeed\Model\Feed $rule */
        ...
        $rendererBlock = $this->getLayout()->createBlock('Mageplaza\ProductFeed\Block\Adminhtml\Feed\Edit\Tab\Renderer\TemplateContent');
        ...
        $rendererBlock = $this->getLayout()
            ->createBlock('Mageplaza\ProductFeed\Block\Adminhtml\Feed\Edit\Tab\Renderer\TemplateContent')
        ...
        $refField = $this->fieldFactory->create(['fieldData' => ['value' => 'csv,txt', 'separator' => ','], 'fieldPrefix' => '']);
