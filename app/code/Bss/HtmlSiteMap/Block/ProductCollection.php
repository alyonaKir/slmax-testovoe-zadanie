...
class ProductCollection extends \Magento\Framework\View\Element\Template
{
    ...
    public function getProductCollection()
    {
        ...
        $collection->addAttributeToFilter(
            [
                ['attribute'=> 'excluded_html_sitemap','null' => true],
                ['attribute'=> 'excluded_html_sitemap','eq' => ''],
                ['attribute'=> 'excluded_html_sitemap','eq' => 'NO FIELD'],
                ['attribute'=> 'excluded_html_sitemap','eq' => '0']
            ]
        );
