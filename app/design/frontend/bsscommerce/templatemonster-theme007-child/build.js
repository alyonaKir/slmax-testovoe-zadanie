({
    ...
    shim: {
        ...
        "FilmSlider": ["jquery"],
        "featuredOwlCarousel":  ["jquery"],
        "featuredCarousel": ["jquery"],
        "featuredTab":["jquery"],
        "featuredProductGallery":["jquery"],
        "featuredSwitchImage":["jquery"],
        "blogCarousel": ["jquery"],
        "categoriesListCollapse": ["jquery"]
    },
    ...
    onModuleBundleComplete: function (data) {
        function onBundleComplete (config, data) {
            ...
            fs.appendFile(fileName, contents, function(){ console.log("done"); } );
       }
